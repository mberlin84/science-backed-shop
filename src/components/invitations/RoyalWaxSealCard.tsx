  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full max-w-md mx-auto">
      <div className="w-full" style={{ perspective: "1500px" }}>
        <div
          className="relative w-full aspect-[3/4] cursor-pointer select-none rounded-sm overflow-hidden shadow-2xl"
          onClick={() => setOpen((o) => !o)}
          role="button"
        ...
        >
          <div
            ...
            style={{
              zIndex: 0,
              background:
                "linear-gradient(135deg, #d4b576 0%, #b8954c 50%, #8f6e2a 100%)",
            }}
          >
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse, rgba(80,55,15,0.18) 0%, transparent 70%)",
              }}
            />
          </div>
          ...
          <div
            ...
            style={{
              zIndex: 20,
              clipPath:
                "polygon(0% 52%, 50% 75%, 100% 52%, 100% 100%, 0% 100%)",
              background:
                "linear-gradient(140deg, #f3e5cf 0%, #e2c891 50%, #c9a564 100%)",
              boxShadow: "inset 0 8px 18px rgba(120,80,30,0.3)",
            }}
          />

          <div
            className="absolute inset-0 origin-top transition-transform [transition-duration:800ms] ease-in-out"
            style={{
          ...
          >
            <div
              ...
              style={{
                clipPath:
                  "polygon(0% 0%, 100% 0%, 100% 52%, 50% 75%, 0% 52%)",
                background:
                  "linear-gradient(160deg, #e9d3a9 0%, #d4b576 55%, #b8954c 100%)",
                boxShadow: "inset 0 -6px 14px rgba(120,80,30,0.45)",
